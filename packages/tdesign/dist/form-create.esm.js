/*!
 * @form-create/tdesign v3.1.32
 * (c) 2018-2024 xaboy
 * Github https://github.com/xaboy/form-create
 * Released under the MIT License.
 */
import { openBlock, createElementBlock, createElementVNode, defineComponent, h, resolveComponent, createVNode, nextTick, mergeProps as mergeProps$1, isVNode, Fragment, markRaw, watch, reactive, getCurrentInstance, provide, inject, toRefs, onBeforeMount, onMounted, onBeforeUnmount, onUpdated, computed, toRef, withDirectives, resolveDirective, ref, createApp } from 'vue';
...
var Frame = defineComponent({
  ...
  render() {
    ...
    }), createVNode(resolveComponent("TDialog"), mergeProps$1({
      width,
      header: title,
      ...this.modal
    }, {
...
var Upload = defineComponent({
  ...
  render() {
    ...
    return createVNode(Fragment, null, [createVNode(resolveComponent("t-upload"), mergeProps$1({
      "max": this.limit,
      "theme": "image",
      "accept": "image/*",
...
var tree = {
  name: 'tree',
  mergeProp(ctx) {
    ctx.prop.props.checkable = true;
  }
};

var parsers = [hidden, radio, checkbox, tree, slider, row, select];
...
var css_248z = ".form-create{width:100%}.form-create .t-tree .t-tree__icon{line-height:inherit}.form-create.t-form:not(.t-form-inline) .t-form__item:last-of-type{margin-bottom:24px}.form-create .form-create .t-is-error .t-input__extra{color:var(--td-error-color)}.form-create .form-create .t-is-warning .t-input__extra{color:var(--td-warning-color)}.form-create .fc-none,.form-create.is-preview .fc-clock{display:none!important}.form-create.is-preview .t-form__label--required>label:before{content:\"\"!important}";

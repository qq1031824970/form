...
(function (global, factory) {
    ...
    var Frame = vue.defineComponent({
      ...
      methods: {
        ...
        makeInput() {
          ...
          return vue.createVNode(vue.resolveComponent("t-input-adornment"), {
            ...
            default: () => [vue.createVNode(vue.resolveComponent("TInput"), {
              "readonly": true,
        ...
        makeFiles() {
          return this.makeGroup(this.fileList.map((src, index) => {
            return this.makeItem(index, [vue.createVNode(IconFile, {
              "size": "20",
      ...
      render() {
        ...
        }), vue.createVNode(vue.resolveComponent("TDialog"), vue.mergeProps({
          width,
          header: title,
          ...this.modal
        }, {

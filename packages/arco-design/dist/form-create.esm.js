 ...
 */
import { defineComponent, toRef, createVNode, resolveComponent, mergeProps as mergeProps$1, openBlock, createElementBlock, createElementVNode, nextTick, isVNode, markRaw, watch, Fragment, reactive, getCurrentInstance, provide, inject, toRefs, onBeforeMount, onMounted, onBeforeUnmount, onUpdated, computed, withDirectives, resolveDirective, ref, createApp, h } from 'vue';
...
var Frame = defineComponent({
  ...
  methods: {
    ...
    makeInput() {
      ...
      if (this.fileList.length && !this.disabled) {
        slots.suffix = () => createVNode(script$3, {
          "class": "_fc-frame-icon",
          "onClick": () => {
            this.fileList = [];
            this.input();
    ...
    makeFiles() {
      return this.makeGroup(this.fileList.map((src, index) => {
        return this.makeItem(index, [createVNode(script$1, {
  ...
  render() {
    ...
    }), createVNode(resolveComponent("aModal"), mergeProps$1({
      width,
      title,
      ...this.modal
    }, {

 ...
 */
import { openBlock, createElementBlock, createElementVNode, defineComponent, resolveComponent, createVNode, Fragment, mergeProps as mergeProps$1, nextTick, isVNode, markRaw, watch, reactive, getCurrentInstance, provide, inject, toRefs, onBeforeMount, onMounted, onBeforeUnmount, onUpdated, computed, toRef, withDirectives, resolveDirective, ref, createApp, h } from 'vue';
...
var Upload = defineComponent({
  ...
  render() {
    ...
    return createVNode(Fragment, null, [createVNode(resolveComponent("AUpload"), mergeProps$1({
      ...
      default: () => [isShow ? ((_this$$slots$default = (_this$$slots = this.$slots).default) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.call(_this$$slots)) || createVNode(script$6, {
        "style": "font-size: 16px; width: 16px;"
      }, null) : null],
      ...getSlot(this.$slots, ['default'])
    }), createVNode(aModal, mergeProps$1({
...
var Frame = defineComponent({
  ...
  methods: {
    ...
    makeInput() {
      ...
      if (this.fileList.length && !this.disabled) {
        slots.suffix = () => createVNode(script$5, {
          "class": "_fc-frame-icon",
          "onClick": () => {
            this.fileList = [];
            this.input();
    ...
    makeFiles() {
      return this.makeGroup(this.fileList.map((src, index) => {
        return this.makeItem(index, [createVNode(script$3, {
          "class": "_fc-frame-icon",
  ...
  render() {
    ...
    }, [Node, createVNode(aModal, mergeProps$1({
      "mask": this.previewMask,
      "title": modalTitle
    }, {
...
var datePicker = {
  ...
  maker: function () {
    return ['date', 'month', 'week'].reduce((initial, type) => {
      ...
      datetimeRange: creatorFactory(name$4, m => m.props({
        type: 'range',
        showTime: true
      }))
    });
...
var hidden = {
  name: name$3,
  maker: {
    [name$3]: (field, value) => creatorFactory(name$3)('', field, value)
  },
  render() {
    return [];
  }
...
function useAlias(maker) {
  ['treeSelect', 'upload', 'frame', 'autoComplete', 'cascader', 'datePicker', 'frame', 'inputNumber', 'inputPassword', 'radio', 'rate', 'switch', 'rate', 'slider', 'timePicker'].reduce((maker, name) => {
    maker[name] = creatorFactory(name);
    return maker;
  }, maker);
...
var css_248z = ".form-create .form-create .ant-form-item{margin-bottom:22px}.form-create .form-create .ant-form-item.ant-form-item-with-help{margin-bottom:3px}.form-create .form-create .ant-form-item .ant-form-item.ant-form-item-with-help{margin-bottom:-22px}.form-create{width:100%}.form-create .fc-none,.form-create.is-preview .fc-clock{display:none!important}.form-create.is-preview .ant-form-item .ant-form-item-label>label.ant-form-item-required:before{content:\"\"!important}";

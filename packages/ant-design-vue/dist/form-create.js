...
(function (global, factory) {
    ...
    var Upload = vue.defineComponent({
      ...
      render() {
        ...
        return vue.createVNode(vue.Fragment, null, [vue.createVNode(vue.resolveComponent("AUpload"), vue.mergeProps({
          ...
          default: () => [isShow ? ((_this$$slots$default = (_this$$slots = this.$slots).default) === null || _this$$slots$default === void 0 ? void 0 : _this$$slots$default.call(_this$$slots)) || vue.createVNode(script$6, {
    ...
    const _hoisted_2$4 = /*#__PURE__*/vue.createElementVNode("svg", {
      height: "1em",
      width: "1em",
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 1024 1024"
    ...
    var Frame = vue.defineComponent({
      ...
      methods: {
        ...
        makeInput() {
          ...
          const slots = {
            addonAfter: () => vue.createVNode(Type, {
              "class": "_fc-frame-icon",
              "onClick": this.showModal
            }, null)
          };
          if (this.fileList.length && !this.disabled) {
            slots.suffix = () => vue.createVNode(script$5, {
              "class": "_fc-frame-icon",
              "onClick": () => {
                this.fileList = [];
                this.input();
        ...
        makeHandleIcon(val, index) {
          const Type = vue.resolveComponent(this.handleIcon === true || this.handleIcon === undefined ? 'EyeOutlined' : this.handleIcon);
        ...
        makeFiles() {
          return this.makeGroup(this.fileList.map((src, index) => {
            return this.makeItem(index, [vue.createVNode(script$3, {
              "class": "_fc-frame-icon",
      ...
      render() {
        ...
        }, [Node, vue.createVNode(aModal, vue.mergeProps({
          "mask": this.previewMask,
          "title": modalTitle
        }, {

 ...
 */
import { defineComponent, toRef, createVNode, resolveComponent, mergeProps as mergeProps$1, openBlock, createElementBlock, createElementVNode, h, nextTick, isVNode, markRaw, watch, Fragment, reactive, getCurrentInstance, provide, inject, toRefs, onBeforeMount, onMounted, onBeforeUnmount, onUpdated, computed, withDirectives, resolveDirective, ref, createApp } from 'vue';
...
var Checkbox = defineComponent({
  ...
  render() {
    ...
    return createVNode(resolveComponent("NCheckboxGroup"), mergeProps$1(this.$attrs, {
      "value": this.value,
      "onUpdate:value": this.onInput,
      "ref": "el"
    }), {
      default: () => [this.options().map((opt, index) => {
        return createVNode(resolveComponent("NCheckbox"), mergeProps$1(opt, {
          "key": '' + index + '-' + opt.value
        }), null);
...
var Radio = defineComponent({
  ...
  render() {
    ...
    return createVNode(resolveComponent("NRadioGroup"), mergeProps$1(this.$attrs, {
      "value": this.value,
      "onUpdate:value": this.onInput,
      "ref": "el"
    }), {
      default: () => [this.options().map((opt, index) => {
        return createVNode(Type, mergeProps$1(opt, {
...
var Frame = defineComponent({
  ...
  render() {
    ...
    }), createVNode(resolveComponent("nModal"), mergeProps$1({
      "preset": 'dialog'
    }, {
      width,
      title,
...
var Upload = defineComponent({
  ...
  render() {
    return createVNode(Fragment, null, [createVNode(resolveComponent("n-upload"), mergeProps$1({
      "max": this.limit,
      "listType": 'image-card'
    }, this.$attrs, {

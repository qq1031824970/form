...
(function (global, factory) {
    ...
    var Checkbox = vue.defineComponent({
      ...
      render() {
        ...
        return vue.createVNode(vue.resolveComponent("NCheckboxGroup"), vue.mergeProps(this.$attrs, {
          "value": this.value,
          "onUpdate:value": this.onInput,
          "ref": "el"
        }), {
          default: () => [this.options().map((opt, index) => {
            return vue.createVNode(vue.resolveComponent("NCheckbox"), vue.mergeProps(opt, {
              "key": '' + index + '-' + opt.value
            }), null);
    ...
    var IconClose = vue.defineComponent({
      name: 'IconClose',
      render() {
        return vue.h('svg', {
          viewBox: '0 0 12 12',
    ...
    var Frame = vue.defineComponent({
      ...
      methods: {
        ...
        makeInput() {
          ...
          if (this.fileList.length && !this.disabled) {
            slots.suffix = () => vue.createVNode(vue.resolveComponent("n-icon"), {
              "component": IconClose,
          ...
          return vue.createVNode(vue.resolveComponent("n-input-group"), null, {
            default: () => [vue.createVNode(vue.resolveComponent("NInput"), {
              "readonly": true,
              "value": this.fileList.map(v => this.getSrc(v)).toString(),
              "key": 1
            }, slots), vue.createVNode(vue.resolveComponent("n-input-group-label"), {
              "onClick": this.showModal,
              "class": "_fc-frame-icon"
            }, {
              default: () => [vue.createVNode(vue.resolveComponent("n-icon"), {
                "component": Type
              }, null)]
            })]
          });
        ...
        makeHandleIcon(val, index) {
          const Type = vue.resolveComponent(this.handleIcon === true || this.handleIcon === undefined ? 'icon-eye' : this.handleIcon);
          return vue.createVNode(vue.resolveComponent("n-icon"), {
            "size": 20,
            "component": Type,
        ...
        makeRemoveIcon(val, index) {
          return vue.createVNode(vue.resolveComponent("n-icon"), {
            "size": 20,
            "component": vue.resolveComponent('icon-trash'),
        ...
        makeFiles() {
          return this.makeGroup(this.fileList.map((src, index) => {
            return this.makeItem(index, [vue.createVNode(vue.resolveComponent("n-icon"), {
              "component": IconFile,
              "size": 20,
        ...
        makeBtn() {
          ...
          return vue.createVNode("div", {
            ...
            "onClick": () => this.showModal(),
            "key": 7
          }, [vue.createVNode(vue.resolveComponent("n-icon"), {
            "component": Type,
            "size": 20,
            "class": "_fc-frame-icon"
          }, null)]);
        ...
        makeFooter() {
          ...
          if (closeBtn) node.push(vue.createVNode(vue.resolveComponent("NButton"), {
            "onClick": () => this.onCancel() !== false && this.closeModal(true)
          }, _isSlot(closeBtnText) ? closeBtnText : {
            default: () => [closeBtnText]
          }));
          if (okBtn) node.push(vue.createVNode(vue.resolveComponent("NButton"), {
            "type": "primary",
      ...
      render() {
        ...
        }, [Node, vue.createVNode(vue.resolveComponent("nModal"), {
          "preset": 'card',
        ...
        }), vue.createVNode(vue.resolveComponent("nModal"), vue.mergeProps({
          "preset": 'dialog'
        }, {
          width,
          title,
    ...
    const _hoisted_3$1 = /*#__PURE__*/vue.createElementVNode("circle", {
      cx: "256",
      cy: "256",
      r: "80",
      fill: "none",
    ...
    var components = [Upload, Sub, Group, Radio, Checkbox, Frame, script$1, Info, script];
    ...
    var datePicker = {
      ...
      maker: function () {
        return ['year', 'month', 'date', 'datetime', 'datetimeRange', 'quarter', 'dateRange'].reduce((initial, type) => {
          initial[type] = creatorFactory(name$2, {
    ...
    var hidden = {
      name: name$1,
      maker: {
        [name$1]: (field, value) => creatorFactory(name$1)('', field, value)
      },
      render() {
        return [];
      }
    ...
    var tree = {
      ...
      render(_, ctx) {
        return ctx.vNode.make('div', {
          style: 'flex: 1 1 0%;'
        }, {
          default: () => [ctx.vNode.tree(ctx.prop, _)]
        });
      }
    };
    ...
    var parsers = [datePicker, hidden, input, tree, select, row];
    ...
    var manager = {
        ...
        if (!isFalse(infoProp.show) && (infoProp.info || infoProp.native) && !isFalse(infoProp.icon)) {
          ...
          children[infoProp.align !== 'left' ? 'unshift' : 'push'](this.$r(mergeProps([infoProp, prop]), {
            ...
            [titleProp.slot || 'trigger']: () => this.$r({
              type: 'NIcon',
              props: {
                component: vue.resolveComponent(infoProp.icon === true ? 'icon-info' : infoProp.icon)
              },
              style: 'top:2px',
              key: `${uni}i`
            }, {}, true)
      ...
      makeFormBtn() {
        ...
        return inline === true ? item : this.$r({
          type: 'col',
          props: {
            span: 24
          },
    ...
    function useAlias(maker) {
      ['dynamicTags', 'colorPicker', 'checkbox', 'upload', 'frame', 'autoComplete', 'cascader', 'datePicker', 'frame', 'inputNumber', 'radio', 'rate', 'switch', 'rate', 'slider', 'timePicker'].reduce((maker, name) => {
        maker[name] = creatorFactory(name);
        return maker;
      }, maker);
      maker.tag = maker.dynamicTags;
    ...
    function useUpload(maker) {
      ...
      Object.keys(types).reduce((maker, key) => {
        maker[key] = creatorFactory('upload', m => m.props({
    ...
    var css_248z = ".form-create{width:100%}.form-create .fc-none,.form-create.is-preview .fc-clock,.form-create.is-preview .n-form-item .n-form-item-label .n-form-item-label__asterisk{display:none!important}";
      ...
      extend(api, {
        ...
        validateField(field, callback) {
          return new Promise((resolve, reject) => {
            ...
            const all = [h.$manager.validateField(ctx)];

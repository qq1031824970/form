 ...
 */
import { openBlock, createElementBlock, createElementVNode, defineComponent, createVNode, resolveComponent, mergeProps, nextTick, isVNode } from 'vue';
  ...
  methods: {
    ...
    makeRemoveIcon(val, index) {
      return createVNode(resolveComponent("ElIcon"), {
        ...
        default: () => [createVNode(script$2, null, null)]
      });
    },
    makeFiles() {
      return this.makeGroup(this.fileList.map((src, index) => {
        return this.makeItem(index, [createVNode(resolveComponent("ElIcon"), {
          ...
          default: () => [createVNode(script$3, null, null)]
